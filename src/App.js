...
const DUMMY_COURSES = [
	...
	},
	{
		...
		status: 'launched',
		description:
			'How do we take proper care of our needs and wants to achieve fulfillment? Let’s find out!',
		duration: 5742,
		lessonsCount: 12,
		containsLockedLessons: false,
		previewImageLink:
		...
		meta: {
			...
			skills: ['taking proper care of needs', 'taking proper care of wants'],
			courseVideoPreview: {
				link: 'https://wisey.app/videos/learn-and-grow-self-improvement/preview/AppleHLS1/preview.m3u8',
				duration: 40,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/learn-and-grow-self-improvement/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'After this course, you’ll be able to aim your focus as easily as a laser pointer.',
		duration: 1468,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/staying-focused-in-a-chaotic-world',
		rating: 4.8,
		meta: {
			...
			courseVideoPreview: {
				...
				duration: 32,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/staying-focused-in-a-chaotic-world/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Learn how to sway negotiations your way and avoid common pitfalls that can derail them.',
		duration: 1566,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/negotiating-for-the-best-outcome',
		rating: 3.5,
		meta: {
			...
			courseVideoPreview: {
				...
				duration: 43,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/negotiating-for-the-best-outcome/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Understand the matter of time and learn how to manipulate it to accomplish more, more easily.',
		duration: 1552,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/how-to-manage-a-time-like-a-pro',
		rating: 4.7,
		meta: {
			...
			courseVideoPreview: {
				...
				duration: 27,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/how-to-manage-a-time-like-a-pro/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Find out how to acquire and retain precious knowledge that you can actually put to use in real life.',
		duration: 1405,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/the-secret-to-speed-learning',
		rating: 4.1,
		meta: {
			...
			courseVideoPreview: {
				...
				duration: 32,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/the-secret-to-speed-learning/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Let us teach you the basics of negotiations to help you prepare for important talks.',
		duration: 1766,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/negotiations-for-life-and-work',
		rating: 4.7,
		meta: {
			...
			courseVideoPreview: {
				...
				duration: 35,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/negotiations-for-life-and-work/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Dealing with procrastination requires a complex approach, and we’ve got one just for you.',
		duration: 1743,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
		...
		meta: {
			...
			courseVideoPreview: {
				...
				duration: 32,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/say-no-to-procrastination/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Join us as we maneuver through the world of manipulations and fakes to discover the truth.',
		duration: 1706,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/how-to-think-critically',
		rating: 4.4,
		meta: {
			...
			courseVideoPreview: {
				...
				duration: 34,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/how-to-think-critically/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Learn about the psychology of habit formation and discover effective ways to build any habit you want.',
		duration: 1458,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/habit-hacking',
		rating: 4.4,
		meta: {
			slug: 'habit-hacking',
			skills: [
			...
			courseVideoPreview: {
				...
				duration: 28,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/habit-hacking/preview',
			},
		},
	},
	{
	...
	},
	{
		...
		status: 'launched',
		description:
			'We all know that one person who always oversteps the line. Let’s learn how to deal with them.',
		duration: 1583,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/toxic-people',
		rating: 4.3,
		meta: {
			slug: 'toxic-people',
			skills: [
			...
			courseVideoPreview: {
				...
				duration: 35,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/toxic-people/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Let’s learn how to combat the 5 mistakes of decision-making and feel more confident in your own choices.',
		duration: 1585,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/rational-decisions',
		rating: 4.3,
		meta: {
			...
			courseVideoPreview: {
				...
				duration: 27,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/rational-decisions/preview',
			},
		},
	},
	{
		...
		status: 'launched',
		description:
			'Beautifully animated short course on how your brain, attention and memory work.',
		duration: 849,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/cognitive-animation',
		rating: 3.5,
		meta: {
	...
	},
	{
		...
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/cognitive-video',
		rating: 4.8,
		meta: {
	...
	},
	{
		...
		status: 'launched',
		description:
			'Interactive experimental short course on how your brain, attention and memory work.',
		duration: 1140,
		lessonsCount: 5,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/cognitive-simulator',
		rating: 4.3,
		meta: {
	...
	},
	{
		...
		status: 'launched',
		description:
			'Learn how to protect yourself from stress & find capabilities to thrive.',
		duration: 17478,
		lessonsCount: 15,
		containsLockedLessons: false,
		previewImageLink:
			'https://wisey.app/assets/images/web/course-covers/stable-mindset',
		rating: 4.5,
		meta: {
			slug: 'stable-mindset',
			skills: [
			...
			courseVideoPreview: {
				...
				duration: 30,
				previewImageLink:
					'https://wisey.app/assets/images/web/course-covers/stable-mindset/preview',
			},
		},
	},
]
...
function App() {
	...
	const lastCourseOnPageIdx = currentCoursesPage * coursesPerPage
	const firstCourseOnPageIdx = lastCourseOnPageIdx - coursesPerPage
	const currentCourses = courses.slice(
		firstCourseOnPageIdx,
		lastCourseOnPageIdx
	)

	const paginationHandler = (event, pageNumber) => {
	...
	return (
		<div className='App'>
			...
			<Main />
			{!viewedCourse && (
				<AllCourses courses={currentCourses} viewed={setViewedCourse} />
			)}
			{!viewedCourse && (
				<Pagination
